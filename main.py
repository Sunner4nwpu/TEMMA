...
if __name__ == '__main__':
    ...
    parser.add_argument('--dropout_mtatten', type=float, default=0.3)
    parser.add_argument('--dropout_ff', type=float, default=0.3)
    parser.add_argument('--dropout_subconnect', type=float, default=0.3)
    parser.add_argument('--dropout_position', type=float, default=0.3)
    parser.add_argument('--dropout_embed', type=float, default=0.3)
    ...
    parser.add_argument('--embed', type=str, default='spatial')
